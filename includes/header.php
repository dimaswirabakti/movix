...
<head>
  ...
  <!-- Google Fonts: Fraunces (display), Hanken Grotesk (body), Space Mono (mono) -->
...
<nav class="navbar navbar-expand-lg navbar-movix sticky-top">
  <div class="container">
    ...
    <div class="d-flex align-items-center gap-2 d-lg-none">
      <button class="btn-icon" type="button" data-bs-toggle="collapse" data-bs-target="#navSearch"
              aria-controls="navSearch" aria-expanded="false" aria-label="Cari">
        <i class="bi bi-search"></i>
      </button>
      <button class="btn-icon border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navMain"
    ...
    <div class="collapse navbar-collapse" id="navMain">
      ...
      <!-- Bagian kanan: search (desktop) + auth/avatar -->
      <div class="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center gap-2">
        <button class="btn-icon d-none d-lg-inline-flex" type="button" data-bs-toggle="collapse"
                data-bs-target="#navSearch" aria-controls="navSearch" aria-expanded="false" aria-label="Cari">
          <i class="bi bi-search"></i>
        </button>

        <?php if ($loggedIn): ?>
          <!-- Mobile: profil + keluar -->
          ...
          <div class="dropdown d-none d-lg-block">
            <button class="btn p-0 border-0 d-flex align-items-center gap-2" type="button"
  ...
  <!-- Panel pencarian (toggle dari ikon search) -->
  <div class="collapse" id="navSearch">
    <div class="container py-2 pb-3">
      <form class="d-flex" role="search" action="/pages/movies.php" method="get">
        <input class="form-control search-input me-2" type="search" name="q"
               placeholder="Cari judul film…" aria-label="Cari film">
